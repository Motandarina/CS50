...
unsigned int hash(const char *word)
{
    ...
    {
        //printf("hello1\n");
        result=(tolower(word[0]) - 'a')*26+(tolower(word[1]) - 'a');
    }
    else if(strlen(word)==3)
    {
        //printf("hello1\n");
        result=(tolower(word[0]) - 'a')*26*26+(tolower(word[1]) - 'a')*26+(tolower(word[2]) - 'a');
    }
    else
    {
        result=(tolower(word[0]) - 'a')*26*26*26+(tolower(word[1]) - 'a')*26*26+(tolower(word[2]) - 'a')*26+(tolower(word[3]) - 'a');
    }
    return result;
}
